...
function InitRepo {
    ...
    git remote add origin "git@github.com:Nigel2392/${PyPiName}.git" | Out-Host
...
Function GITHUB_UpdateVersion {
    ...
    $newVersion = GITHUB_NextVersion -ConfigFile $ConfigFile -PyVersionFile $PyVersionFile
